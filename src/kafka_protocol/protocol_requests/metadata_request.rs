...
mod tests {
    ...
    fn verify_request() {
        ...
        assert_eq!(
            vec![0, 0, 0, 19, 0, 3, 0, 5, 0, 0, 0, 42, 0, 4, 115, 101, 97, 110, 0, 0, 0, 0, 0],
            bytes
        );
        println!("{:?}", bytes);
    }
    ...
    fn verify_metadata_request() {
        ...
        let expected: Vec<u8> = vec![
            0, 0, 0, 2, 0, 16, 0x6D, 0x79, 0x5F, 0x6B, 0x61, 0x66, 0x6B, 0x61, 0x5F, 0x74, 0x6F,
            0x70, 0x69, 0x63, 0x5F, 0x31, 0, 16, 0x6D, 0x79, 0x5F, 0x6B, 0x61, 0x66, 0x6B, 0x61,
            0x5F, 0x74, 0x6F, 0x70, 0x69, 0x63, 0x5F, 0x32, 1,
        ];
